...
import stylesCss from 'themes/vaadinstarter/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_vaadinstarter_componentCss']) {
    
    document['_vaadintheme_vaadinstarter_componentCss'] = true;
  }
